      ...
      <div className="w-full flex flex-col justify-center items-center gap-0">
        <div style={{color: "var(--brand-text-main)"}} className="w-full flex justify-center pt-8">
          <div className="max-w-[720px] px-6 w-full flex flex-col gap-4">
            ...
            <p>
              Coppa Nouns is a football-loving DAO that brings the beautiful game on-chain. 
              ...
              <p>
              If you believe in a team or want to support your favorite country, mint a Coppa Noun and help us bring the beautiful game on-chain.
              </p>
          </div>
        </div>
      </div>
